...
class PoisonZyounin :public  ObjectBase {
public:
	PoisonZyounin(int x, int y, bool flip);
	~PoisonZyounin();

	virtual OBJECTTYPE	GetObjType() { return OBJECTTYPE::POISONZYOUNIN; }
	void Init();
...
namespace PzNInfo {
	...
	//出現
	constexpr auto APPEAR_GRAPHNAME = "res/Gimik/Z_Poison_Stand.png";	//画像ファイル名
	...
	//索敵
	constexpr auto PATROL_GRAPHNAME = "res/Gimik/Z_Poison_Stand.png";	//画像ファイル名
	...
	//毒液垂らし
	constexpr auto POISING_GRAPHNAME = "res/Gimik/Z_Poison.png";	//画像ファイル名
