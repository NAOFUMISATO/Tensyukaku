...
BossMapChip::BossMapChip(std::string filePath, std::string tiledFileName)
{
...
// 文字列のファイルをロードする
std::string BossMapChip::StringFileLoad(std::string strFileName)
{
	// ファイルを開く
	FILE* fp;
...
// Tiled-jsonデータロード
int		BossMapChip::TiledJsonLoad(std::string filePath, std::string strFileName)
{
	// ファイルを開いてstringを取得する
...
void	BossMapChip::Process(Game& g)
{
...
int BossMapChip::CheckHit(int x, int y)
{
...
//   0 : 当たってない
//   1 : 当たった
int BossMapChip::IsHit(ObjectBase& o, int mx, int my)
{
	int x, y;
