...
public:
	...
	enum class OBJECTTYPE {
		...
		STAIR,BOSSSTAIR, RESTPOINT,POISONNINJA,POISONZYOUNIN, POISON,STRPOISON,ANDON,FLAME, MUGENANDON,MUGENFLAME,SPAWNBLOCK, EVENTBLOCK, RECOVERYBLOCK,CPOINTBLOCK,BOSSEVENTBLOCK,FLAMEBLOCK, TUTORIALBLOCK,BOSSSPAWN
	};
