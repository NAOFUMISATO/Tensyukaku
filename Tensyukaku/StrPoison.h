...
namespace SPInfo {
	...
	//毒液準備
	constexpr auto RESERVE_GRAPHNAME = "res/Gimik/StrPoisonReserve.png";	//画像ファイル名
	...
	//毒液落下
	constexpr auto FALL_GRAPHNAME = "res/Gimik/StrPoisonFall.png";	//画像ファイル名
	...
	//毒液着地
	constexpr auto LAND_GRAPHNAME = "res/Gimik/StrPoisonLand.png";	//画像ファイル名
