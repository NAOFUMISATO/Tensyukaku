...
namespace SpaInfo {
	...
	constexpr auto  SPAWN1A_BUSHI1_X = 1200;	constexpr auto  SPAWN1A_BUSHI1_Y = 9360;	constexpr auto  SPAWN1A_BUSHI1_FLIP = false;	//武士1
	...
	//スポーンブロック1B
	constexpr auto SPAWN1B_XPOSITION = 2500;	constexpr auto SPAWN1B_YPOSITION = 9360;	//スポーンブロック1B
	constexpr auto  SPAWN1B_BUSHI1_X = 2000;	constexpr auto  SPAWN1B_BUSHI1_Y = 9360;	constexpr auto  SPAWN1B_BUSHI1_FLIP = true;	//武士1
	...
	//スポーンブロック2A
	constexpr auto  SPAWN2A_XPOSITION = 3800;	constexpr auto SPAWN2A_YPOSITION = 8600;	//スポーンブロック2A
	...
	constexpr auto  SPAWN2B_NINJA1_X = 1200;		constexpr auto  SPAWN2B_NINJA1_Y = 8600;	constexpr auto  SPAWN2B_NINJA1_FLIP = true;		constexpr auto  SPAWN2B_NINJA1_KUNAI = 1;	//忍者1
	constexpr auto  SPAWN2B_NINJA2_X = 900;		constexpr auto  SPAWN2B_NINJA2_Y = 8600;	constexpr auto  SPAWN2B_NINJA2_FLIP = true;		constexpr auto  SPAWN2B_NINJA2_KUNAI = 0;	//忍者2
	...
	constexpr auto  SPAWN3C_SHIEL2_X = 3400;	constexpr auto  SPAWN3C_SHIEL2_Y = 7840;	constexpr auto  SPAWN3C_SHIEL2_FLIP = false;	//盾兵2
	//スポーンブロック3D
	...
	constexpr auto  SPAWN3E_LANCE1_X = 4200;	constexpr auto  SPAWN3E_LANCE1_Y = 7840;	constexpr auto  SPAWN3E_LANCE1_FLIP = true;	//槍兵1
	//スポーンブロック4A
	...
	constexpr auto  SPAWN4D_LANCE1_X = 900;		constexpr auto  SPAWN4D_LANCE1_Y = 7080;	constexpr auto  SPAWN4D_LANCE1_FLIP = true;	//槍兵1
	constexpr auto  SPAWN4D_BUSHI1_X = 400;		constexpr auto  SPAWN4D_BUSHI1_Y = 7080;	constexpr auto  SPAWN4D_BUSHI1_FLIP = true;	//武士1
	//スポーンブロック5A
	...
	constexpr auto  SPAWN5B_SHIEL1_X = 4400;		constexpr auto  SPAWN5B_SHIEL1_Y = 6320;	constexpr auto  SPAWN5B_SHIEL1_FLIP = true;		//盾兵1
	constexpr auto  SPAWN5B_SHIEL2_X = 5400;		constexpr auto  SPAWN5B_SHIEL2_Y = 6320;	constexpr auto  SPAWN5B_SHIEL2_FLIP = false;		//盾兵2
	//スポーンブロック5C
	constexpr auto  SPAWN5C_XPOSITION = 5700;	constexpr auto  SPAWN5C_YPOSITION = 6320;	//スポーンブロック5C
	constexpr auto  SPAWN5C_BUSHI1_X = 4900;	constexpr auto  SPAWN5C_BUSHI1_Y = 5560;	constexpr auto  SPAWN5C_BUSHI1_FLIP = true;	//武士1
	...
	constexpr auto  SPAWN5C_NINJA1_X = 4600;		constexpr auto  SPAWN5C_NINJA1_Y = 5560;		constexpr auto  SPAWN5C_NINJA1_FLIP = true;	constexpr auto  SPAWN5C_NINJA1_KUNAI = 1;	//忍者1
	...
	//スポーンブロック8A
	constexpr auto  SPAWN8A_XPOSITION = 4800;	constexpr auto SPAWN8A_YPOSITION = 4040;	//スポーンブロック8A
	...
	constexpr auto  SPAWN9A_NINJA1_X = 4400;		constexpr auto  SPAWN9A_NINJA1_Y = 3280;		constexpr auto  SPAWN9A_NINJA1_FLIP = false;	constexpr auto  SPAWN9A_NINJA1_KUNAI = 2;	//忍者1
	//スポーンブロック9B
	...
	constexpr auto  SPAWN9B_ZYONI1_X = 2900;		constexpr auto  SPAWN9B_ZYONI1_Y = 3280;		constexpr auto  SPAWN9B_ZYONI1_FLIP = true;	constexpr auto  SPAWN9B_ZYONI1_KUNAI = 4;	//上忍1
	//スポーンブロック10A
	constexpr auto  SPAWN10A_XPOSITION = 1000;	constexpr auto SPAWN10A_YPOSITION = 2520;	//スポーンブロック10A
	constexpr auto  SPAWN10A_BUSHI1_X = 500;	constexpr auto  SPAWN10A_BUSHI1_Y = 2520;	constexpr auto  SPAWN10A_BUSHI1_FLIP = true;		//武士1
	...
	constexpr auto  SPAWN10B_BUSHI1_X = 2000;	constexpr auto  SPAWN10B_BUSHI1_Y = 2520;	constexpr auto  SPAWN10B_BUSHI1_FLIP = true;	//武士1
	constexpr auto  SPAWN10B_BUSHI2_X = 3100;	constexpr auto  SPAWN10B_BUSHI2_Y = 2520;	constexpr auto  SPAWN10B_BUSHI2_FLIP = false;	//武士2
	constexpr auto  SPAWN10B_BUSHI3_X = 3700;	constexpr auto  SPAWN10B_BUSHI3_Y = 2520;	constexpr auto  SPAWN10B_BUSHI3_FLIP = false;	//武士3
	constexpr auto  SPAWN10B_SHIEL1_X = 3400;	constexpr auto  SPAWN10B_SHIEL1_Y = 2520;	constexpr auto  SPAWN10B_SHIEL1_FLIP = false;	//盾兵1
	constexpr auto  SPAWN10B_NINJA1_X = 1800;	constexpr auto  SPAWN10B_NINJA1_Y = 2520;	constexpr auto  SPAWN10B_NINJA1_FLIP = true;	constexpr auto  SPAWN10B_NINJA1_KUNAI = 1;	//忍者1
	constexpr auto  SPAWN10B_ZYONI1_X = 4000;	constexpr auto  SPAWN10B_ZYONI1_Y = 2520;	constexpr auto  SPAWN10B_ZYONI1_FLIP = true;	constexpr auto  SPAWN10B_ZYONI1_KUNAI = 4;	//上忍1
	//スポーンブロック11A
	...
	constexpr auto  SPAWN11B_BUSHI1_X = 3600;	constexpr auto SPAWN11B_BUSHI1_Y = 1760;	constexpr auto SPAWN11B_BUSHI1_FLIP = true;		//武士1
	constexpr auto  SPAWN11B_SHIEL1_X = 3900 ;	constexpr auto  SPAWN11B_SHIEL1_Y = 1760;	constexpr auto  SPAWN11B_SHIEL1_FLIP = true;		//盾兵1
	//スポーンブロック11C
	constexpr auto  SPAWN11C_XPOSITION = 3900;	constexpr auto SPAWN11C_YPOSITION = 1760;	//スポーンブロック11C
	constexpr auto  SPAWN11C_ZYONI1_X =	 2700;	constexpr auto  SPAWN11C_ZYONI1_Y = 1760;	constexpr auto  SPAWN11C_ZYONI1_FLIP = true;	constexpr auto  SPAWN11C_ZYONI1_KUNAI = 8;	//上忍1
	//スポーンブロック11D
	constexpr auto  SPAWN11D_XPOSITION = 2600;	constexpr auto SPAWN11D_YPOSITION = 1760;	//スポーンブロック11D
	constexpr auto  SPAWN11D_LANCE1_X = 1700;	constexpr auto  SPAWN11D_LANCE1_Y = 1760; constexpr auto  SPAWN11D_LANCE1_FLIP = false;	//槍兵1
	constexpr auto  SPAWN11D_SHIEL1_X = 2000;	constexpr auto  SPAWN11D_SHIEL1_Y = 1760; constexpr auto  SPAWN11D_SHIEL1_FLIP = false;		//盾兵1
	constexpr auto  SPAWN11D_NINJA1_X = 1400;  constexpr auto SPAWN11D_NINJA1_Y = 1760;  constexpr auto SPAWN11D_NINJA1_FLIP = true;		constexpr auto  SPAWN11D_NINJA1_KUNAI = 2;	//忍者1
	//スポーンブロック11E
	...
	//スポーンブロック11F
	constexpr auto  SPAWN11F_XPOSITION = 500; constexpr auto SPAWN11F_YPOSITION = 1760;	//スポーンブロック11F
	constexpr auto  SPAWN11F_BUSHI1_X = 1000;	constexpr auto  SPAWN11F_BUSHI1_Y = 1000; constexpr auto SPAWN11F_BUSHI1_FLIP = false;	//武士1
	constexpr auto  SPAWN11F_NINJA1_X = 1300;	constexpr auto  SPAWN11F_NINJA1_Y = 1000; constexpr auto  SPAWN11F_NINJA1_FLIP = false; constexpr auto  SPAWN11F_NINJA1_KUNAI = 1;//忍者1
	//スポーンブロック12A
	...
	constexpr auto  SPAWN12B_BUSHI1_X = 1400;	constexpr auto  SPAWN12B_BUSHI1_Y = 1000;	constexpr auto  SPAWN12B_BUSHI1_FLIP = false;	//武士1
	constexpr auto  SPAWN12B_LANCE1_X = 1700;	constexpr auto  SPAWN12B_LANCE1_Y = 1000; constexpr auto  SPAWN12B_LANCE1_FLIP = false;	//槍兵1
	//スポーンブロック12C
