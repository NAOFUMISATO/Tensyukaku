...
namespace PInfo {
	...
	constexpr auto AnimeSpeed_Move = 6;			//移動状態
	constexpr auto AnimeSpeed_MiddleAttack = 4;	//中段攻撃
	constexpr auto AnimeSpeed_LowAttack = 4;	//下段攻撃
	constexpr auto AnimeSpeed_Kick = 5;			//蹴り
	constexpr auto AnimeSpeed_Iai = 5;			//居合
	constexpr auto AnimeSpeed_Sway = 5;			//スウェイ
	constexpr auto AnimeSpeed_Damage = 40;		//被ダメ
	constexpr auto AnimeSpeed_Dead = 120;		//死亡
